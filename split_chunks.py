...
original_chunks = [
    ...
    ("chunk_31.txt",  7469, 7769, "May 11 - May 16"),
    ("chunk_32.txt",  7769, 8069, "May 16 - May 18"),
    ("chunk_33.txt",  8069, 8088, "May 18"),
    ("chunk_34.txt",  8088, 8388, "May 18 - May 23"),
    ("chunk_35.txt",  8388, 8688, "May 23 - May 24"),
    ("chunk_36.txt",  8688, 8988, "May 24 - May 25"),
    ("chunk_37.txt",  8988, 9257, "May 25 - May 26"),
    ("chunk_38.txt",  9258, 9557, "May 26 - May 28"),
    ("chunk_39.txt",  9558, 9857, "May 28 - May 29"),
    ("chunk_40.txt",  9858, 10157, "May 29 - May 30"),
    ("chunk_41.txt",  10158, 10457, "May 30 - May 31"),
    ("chunk_42.txt",  10458, 10757, "May 31 - Jun 1"),
    ("chunk_43.txt",  10758, 10765, "Jun 1"),
    ("chunk_44.txt",  10765, 11065, "Jun 1 - Jun 5"),
    ("chunk_45.txt",  11065, 11365, "Jun 5 - Jun 6"),
    ("chunk_46.txt",  11365, 11665, "Jun 6 - Jun 7"),
    ("chunk_47.txt",  11665, 11909, "Jun 7 - Jun 9"),
    ("chunk_48.txt",  11909, 12209, "Jun 9 - Jun 12"),
    ("chunk_49.txt",  12209, 12509, "Jun 12 - Jun 13"),
    ("chunk_50.txt",  12509, 12809, "Jun 13 - Jun 14"),
    ("chunk_51.txt",  12809, 12958, "Jun 14 - Jun 15"),
    ("chunk_52.txt",  12958, 13258, "Jun 15 - Jun 18"),
    ("chunk_53.txt",  13258, 13558, "Jun 18 - Jun 19"),
    ("chunk_54.txt",  13558, 13858, "Jun 20 - Jun 21"),
    ("chunk_55.txt",  13858, 14143, "Jun 21 - Jun 23"),
    ("chunk_56.txt",  14143, 14443, "Jun 23 - Jun 25"),
    ("chunk_57.txt",  14443, 14743, "Jun 25 - Jun 27"),
    ("chunk_58.txt",  14743, 15043, "Jun 27 - Jun 28"),
    ("chunk_59.txt",  15043, 15343, "Jun 28 - Jun 30"),
]
