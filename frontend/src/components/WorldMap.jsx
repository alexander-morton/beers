...
const CITY_COORDS = {
  ...
  'Baroondah': [149.630, -24.894],
  'Berkshire': [-1.030, 51.430],
  'Berlin': [13.405, 52.520],
  'Bintan Island': [104.527, 0.918],
  'Boston': [-71.059, 42.360],
  'Cape Cod': [-70.200, 41.700],
  'Chester': [-2.893, 53.191],
  'Chesterfield': [-1.426, 53.235],
  'Chichester': [-0.780, 50.836],
  'Christchurch': [172.636, -43.532],
  'Den Haag': [4.316, 52.070],
  'Dunfermline': [-3.438, 56.071],
  'Fiji': [178.065, -17.713],
  'Florida': [-81.516, 27.664],
  'Greece': [21.824, 39.074],
  'Harrogate': [-1.541, 53.992],
  'Ibiza': [1.432, 38.906],
  'Indianapolis': [-86.158, 39.768],
  'Italy': [12.567, 41.871],
  'Jura': [6.143, 46.783],
  'Krabi': [98.909, 8.086],
  'Morocco': [-7.092, 31.792],
  'NSW': [147.000, -32.000],
  'Norfolk': [1.297, 52.630],
  'Orlando': [-81.379, 28.538],
  'Oxfordshire': [-1.246, 51.752],
  'Paisley': [-4.429, 55.847],
  'Providence': [-71.413, 41.824],
  'Ribble Valley': [-2.391, 53.873],
  'Saigon': [106.629, 10.823],
  'Saitama': [139.649, 35.861],
  'Scotland': [-4.203, 56.490],
  'Seaford': [0.103, 50.772],
  'Seattle': [-122.332, 47.606],
  'Sidcup': [0.103, 51.426],
  'Thailand': [100.992, 15.870],
  'Vatican City': [12.453, 41.903],
  'Venice': [12.315, 45.440],
  'West Sussex': [-0.447, 50.944],
}
